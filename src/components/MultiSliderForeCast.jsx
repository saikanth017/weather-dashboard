...
function MultiSliderForeCast({ id }) {
  ...
  const pastData = useSelector((state) => state.farmer.value.pData);
          ...
          ? Object.keys(pastData).length > 0
            ? Object.keys(pastData).map((date) => (
                ...
                >
                  ...
                  >
                    <Typography sx={{ fontSize: 35, marginTop: 1.5 }}>
                      {pastData[date].forecast.forecastday[0].day.maxtemp_c}°C
                    </Typography>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <Typography>
                        {
                          pastData[date].forecast.forecastday[0].day
                            .daily_chance_of_rain
                        }
                        %
                      </Typography>
                  ...
                  >
                    <div>
                      <Typography sx={{ fontSize: 10 }}>
                        Sun Rise :{" "}
                        {pastData[date].forecast.forecastday[0].astro.sunrise}
                      </Typography>
                      <Typography sx={{ fontSize: 10 }}>
                        Sun Set :{" "}
                        {pastData[date].forecast.forecastday[0].astro.sunset}
                      </Typography>
                    </div>
                    <div
                      style={{
                    ...
                    <div>
                      <Typography sx={{ fontSize: 10 }}>
                        Humidity :
                        {
                          pastData[date].forecast.forecastday[0].hour[0]
                            .humidity
                        }{" "}
                        %
                      </Typography>
                  ...
                  >
                    <img
                      style={{ height: 50 }}
                      src={
                        pastData[date].forecast.forecastday[0].day["condition"]
                          .icon
                      }
                    ></img>
                    <div>
              ...
              >
                ...
                >
                  <img
                    style={{ height: 50 }}
                    src={
                      travelData[date].forecast.forecastday[0].day["condition"]
                        .icon
                    }
                  ></img>
                  <div>
